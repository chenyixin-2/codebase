...
describe('WalkontableEvent', function () {
  ...
  it('border click should call `onCellMouseDown` callback', function () {
    ...
    $table.parents('.wtHolder').find('.wtBorder:first').simulate('mousedown');
  ...
  it('border click should call `onCellDblClick` callback', function () {
    ...
    $table.parents('.wtHolder').find('.wtBorder:first').simulate('mousedown').simulate('mouseup').simulate('mousedown').simulate('mouseup');
