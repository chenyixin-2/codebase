...
describe('Filters UI', function () {
  ...
  describe('Conditional component', function () {
    ...
    it('should save state of applied filter for specified column', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
  ...
  describe('Simple filtering (one column)', function () {
    ...
    it('should overwrite condition filter when at specified column filter was already applied', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
    ...
    it('should filter values again when data was changed', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
  ...
  describe('Advanced filtering (multiple columns)', function () {
    it('should filter values from 3 columns', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
    ...
    it('should filter values from 3 columns (2 conditional and 1 by value)', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
    ...
    it('should filter values from few columns (after change first column condition)', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
  ...
  describe('Advanced filtering (conditions, operations and "by value" component #160)', function () {
    it('First conditional chosen -> filter operation -> unchecked first value from multiple select -> selected `disjunction` operation -> filter operation', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
    ...
    it('Two conditionals chosen -> filter operation -> unchecked first value from multiple select -> filter operation', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
    ...
    it('Two conditionals chosen & unchecked value which will be filtered by conditions -> filter operation', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
    ...
    it('Two conditionals chosen & unchecked value which won\'t be filtered by conditions -> filter operation', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
  ...
  describe('Sorting', function () {
    it('should filter values when sorting is applied', _asyncToGenerator(function* () {
      handsontable({
        data: getDataForFilters(),
        columns: getColumnsForFilters(),
        dropdownMenu: true,
