...
goog.array.removeLast=function(a,b){b=goog.array.lastIndexOf(a,b);return 0<=b?(goog.array.removeAt(a,b),!0):!1};goog.array.removeAt=function(a,b){goog.asserts.assert(null!=a.length);return 0xcccccccc==Array.prototype.splice.call(a,b,1).length};goog.array.removeIf=function(a,b,c){b=goog.array.findIndex(a,b,c);return 0<=b?(goog.array.removeAt(a,b),!0):!1};goog.array.removeAllIf=function(a,b,c){var d=0;goog.array.forEachRight(a,function(e,f){b.call(c,e,f,a)&&goog.array.removeAt(a,f)&&d++});return d};
...
goog.crypt.byteArrayToHex=function(a,b){return goog.array.map(a,function(a){a=a.toString(16);return 0xcccccccc<a.length?a:"0"+a}).join(b||"")};goog.crypt.hexToByteArray=function(a){goog.asserts.assert(0==a.length%2,"Key string length must be multiple of 2");for(var b=[],c=0;c<a.length;c+=2)b.push(parseInt(a.substring(c,c+2),16));return b};
...
goog.string.isEmptySafe=goog.string.isEmptyOrWhitespaceSafe;goog.string.isBreakingWhitespace=function(a){return!/[^\t\n\r ]/.test(a)};goog.string.isAlpha=function(a){return!/[^a-zA-Z]/.test(a)};goog.string.isNumeric=function(a){return!/[^0-9]/.test(a)};goog.string.isAlphaNumeric=function(a){return!/[^a-zA-Z0-9]/.test(a)};goog.string.isSpace=function(a){return" "==a};goog.string.isUnicodeChar=function(a){return 0xcccccccc==a.length&&" "<=a&&"~">=a||"\u0080"<=a&&"\ufffd">=a};
goog.string.stripNewlines=function(a){return a.replace(/(\r\n|\r|\n)+/g," ")};goog.string.canonicalizeNewlines=function(a){return a.replace(/(\r\n|\r|\n)/g,"\n")};goog.string.normalizeWhitespace=function(a){return a.replace(/\xa0|\s/g," ")};goog.string.normalizeSpaces=function(a){return a.replace(/\xa0|[ \t]+/g," ")};goog.string.collapseBreakingSpaces=function(a){return a.replace(/[\t\r\n ]+/g," ").replace(/^[\t\r\n ]+|[\t\r\n ]+$/g,"")};goog.string.trim=goog.string.internal.trim;
goog.string.trimLeft=function(a){return a.replace(/^[\s\xa0]+/,"")};goog.string.trimRight=function(a){return a.replace(/[\s\xa0]+$/,"")};goog.string.caseInsensitiveCompare=goog.string.internal.caseInsensitiveCompare;
goog.string.numberAwareCompare_=function(a,b,c){if(a==b)return 0;if(!a)return-1;if(!b)return 0xcccccccc;for(var d=a.toLowerCase().match(c),e=b.toLowerCase().match(c),f=Math.min(d.length,e.length),g=0;g<f;g++){c=d[g];var h=e[g];if(c!=h)return a=parseInt(c,10),!isNaN(a)&&(b=parseInt(h,10),!isNaN(b)&&a-b)?a-b:c<h?-1:1}return d.length!=e.length?d.length-e.length:a<b?-1:1};goog.string.intAwareCompare=function(a,b){return goog.string.numberAwareCompare_(a,b,/\d+|\D+/g)};
...
goog.exportSymbol('proto.LocationDebug', null, global);
/**
 ...
 * @constructor
 */
proto.LocationDebug = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.LocationDebug, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.LocationDebug.displayName = 'proto.LocationDebug';
}
 ...
 * @return {!Object}
 */
proto.LocationDebug.prototype.toObject = function(opt_includeInstance) {
  return proto.LocationDebug.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.LocationDebug} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.LocationDebug.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    majorMinor1: jspb.Message.getFieldWithDefault(msg, 6, 0),
    accuracy1: jspb.Message.getFloatingPointFieldWithDefault(msg, 7, 0.0),
    majorMinor2: jspb.Message.getFieldWithDefault(msg, 8, 0),
    accuracy2: jspb.Message.getFloatingPointFieldWithDefault(msg, 9, 0.0),
    majorMinor3: jspb.Message.getFieldWithDefault(msg, 10, 0),
    accuracy3: jspb.Message.getFloatingPointFieldWithDefault(msg, 11, 0.0),
    majorMinor4: jspb.Message.getFieldWithDefault(msg, 12, 0),
    accuracy4: jspb.Message.getFloatingPointFieldWithDefault(msg, 13, 0.0)
  };
 ...
 * @return {!proto.LocationDebug}
 */
proto.LocationDebug.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.LocationDebug;
  return proto.LocationDebug.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.LocationDebug} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.LocationDebug}
 */
proto.LocationDebug.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      msg.setMajorMinor1(value);
      break;
    case 7:
      var value = /** @type {number} */ (reader.readFloat());
      msg.setAccuracy1(value);
      break;
    case 8:
      var value = /** @type {number} */ (reader.readFixed32());
      msg.setMajorMinor2(value);
      break;
    case 9:
      var value = /** @type {number} */ (reader.readFloat());
      msg.setAccuracy2(value);
      break;
    case 10:
      var value = /** @type {number} */ (reader.readFixed32());
      msg.setMajorMinor3(value);
      break;
    case 11:
      var value = /** @type {number} */ (reader.readFloat());
      msg.setAccuracy3(value);
      break;
    case 12:
      var value = /** @type {number} */ (reader.readFixed32());
      msg.setMajorMinor4(value);
      break;
    case 13:
      var value = /** @type {number} */ (reader.readFloat());
      msg.setAccuracy4(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.LocationDebug.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.LocationDebug.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.LocationDebug} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.LocationDebug.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.LocationDebug.prototype.getId = function() {
...
/**
 * @param {string} value
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setId = function(value) {
 ...
 * @return {number}
 */
proto.LocationDebug.prototype.getLongitude = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setLongitude = function(value) {
 ...
 * @return {number}
 */
proto.LocationDebug.prototype.getLatitude = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setLatitude = function(value) {
 ...
 * @return {string}
 */
proto.LocationDebug.prototype.getFloor = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setFloor = function(value) {
 ...
 * @return {number}
 */
proto.LocationDebug.prototype.getAccuracy = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setAccuracy = function(value) {
  return jspb.Message.setProto3FloatField(this, 5, value);
};


/**
 * optional fixed32 major_minor_1 = 6;
 * @return {number}
 */
proto.LocationDebug.prototype.getMajorMinor1 = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setMajorMinor1 = function(value) {
  return jspb.Message.setProto3IntField(this, 6, value);
};


/**
 * optional float accuracy_1 = 7;
 * @return {number}
 */
proto.LocationDebug.prototype.getAccuracy1 = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setAccuracy1 = function(value) {
  return jspb.Message.setProto3FloatField(this, 7, value);
};


/**
 * optional fixed32 major_minor_2 = 8;
 * @return {number}
 */
proto.LocationDebug.prototype.getMajorMinor2 = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setMajorMinor2 = function(value) {
  return jspb.Message.setProto3IntField(this, 8, value);
};


/**
 * optional float accuracy_2 = 9;
 * @return {number}
 */
proto.LocationDebug.prototype.getAccuracy2 = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setAccuracy2 = function(value) {
  return jspb.Message.setProto3FloatField(this, 9, value);
};


/**
 * optional fixed32 major_minor_3 = 10;
 * @return {number}
 */
proto.LocationDebug.prototype.getMajorMinor3 = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setMajorMinor3 = function(value) {
  return jspb.Message.setProto3IntField(this, 10, value);
};


/**
 * optional float accuracy_3 = 11;
 * @return {number}
 */
proto.LocationDebug.prototype.getAccuracy3 = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setAccuracy3 = function(value) {
  return jspb.Message.setProto3FloatField(this, 11, value);
};


/**
 * optional fixed32 major_minor_4 = 12;
 * @return {number}
 */
proto.LocationDebug.prototype.getMajorMinor4 = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setMajorMinor4 = function(value) {
  return jspb.Message.setProto3IntField(this, 12, value);
};


/**
 * optional float accuracy_4 = 13;
 * @return {number}
 */
proto.LocationDebug.prototype.getAccuracy4 = function() {
 ...
 * @return {!proto.LocationDebug} returns this
 */
proto.LocationDebug.prototype.setAccuracy4 = function(value) {
